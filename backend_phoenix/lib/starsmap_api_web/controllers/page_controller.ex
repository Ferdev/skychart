defmodule StarsmapApiWeb.PageController do
  ...
  def about(conn, _params) do
    ...
    <section><h3>DESI Legacy Imaging Surveys DR11</h3><p>Coordinate-centered object imagery uses the <a href="https://www.legacysurvey.org/dr11/">Legacy Surveys Data Release 11</a> optical map through its public Sky Viewer. DR11 imagery provides angular observing context and does not determine distances in the atlas. See the <a href="https://newscenter.lbl.gov/2026/08/10/scientists-release-biggest-2d-map-of-the-universe/">Berkeley Lab release</a>.</p></section>

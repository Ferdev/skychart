defmodule StarsmapApi.Repo.Migrations.AddBassDr2CatalogSource do
  use Ecto.Migration
  ...
  def up do
    execute "CREATE TABLE catalog_bass_dr2_objects (LIKE catalog_simbad_objects INCLUDING ALL)"
    replace_source_union_view(@source_tables)
  end

  def down do
    replace_source_union_view(Enum.reject(@source_tables, &(&1 == :catalog_bass_dr2_objects)))
    execute "DROP TABLE catalog_bass_dr2_objects"
  end

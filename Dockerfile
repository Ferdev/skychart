...
COPY --chown=app:app scripts/import_erosita_dr2_catalog.py scripts/import_erosita_dr2_catalog.py
COPY --chown=app:app scripts/import_sdss_spiders_dr20_catalog.py scripts/import_sdss_spiders_dr20_catalog.py
